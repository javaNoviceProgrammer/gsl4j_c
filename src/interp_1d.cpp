 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_org_gsl4j_interpolate_Interpolation1D_eval
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_org_gsl4j_interpolate_Interpolation1D_deriv
(JNIEnv *env, jobject Interpolation1D, jdouble x) {
	Interpolator1D *interp = new Interpolator1D(env, Interpolation1D) ;
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_org_gsl4j_interpolate_Interpolation1D_deriv2
(JNIEnv *env, jobject Interpolation1D, jdouble x) {
	Interpolator1D *interp = new Interpolator1D(env, Interpolation1D) ;
